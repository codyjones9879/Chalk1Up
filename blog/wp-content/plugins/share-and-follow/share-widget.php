	...
	function update( $new_instance, $old_instance ) {
		...
		/* Set up some default widget settings. */
               ...
               $args2 = array();
                ...
                foreach ($args2 as $item){
                $default[$item] = $devOptions[$item];
                $default[$item.'_share_text'] = $devOptions[$item.'_share_text'];
                $default[$item.'_popup_text'] = $devOptions[$item.'_popup_text'];
                }
                $default['email_body_text'] = $devOptions['email_body_text'];
