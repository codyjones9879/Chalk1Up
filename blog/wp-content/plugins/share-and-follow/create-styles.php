...
if ($cssOptions['cssid']==$devOptions['cssid'] && $devOptions['add_css']=='false'){
...
$buildCss .= "padding:10px 0;font-family:impact,charcoal,arial, helvetica,sans-serif;-moz-border-radius-top".$corner.": 5px;-webkit-border-top-".$corner."-radius:5px;-moz-border-radius-bottom".$corner.":5px;-webkit-border-bottom-".$corner."-radius:5px;";
   ...
   $buildCss .= "#follow.".$devOptions['follow_location']." ul li {padding-bottom:".$devOptions['follow_list_spacing']."px;list-style-type:none !important;padding-left:4px;padding-right:4px}\n";
//end of box setup

// turn off if not needed
// if($devOptions['add_follow_text']=="true"){
$buildCss .="#follow img{border:none;}";
$buildCss .="#follow.".$devOptions['follow_location']." ul li.".$devOptions['word_value']." {margin:0 4px;}\n";
...
//
if ($devOptions['follow_list_style']=='text_replace'){
    ...
    foreach ($follow_words_list as $key=>$value){
        ...
        if ($devOptions['follow_'.$key]=='yes'|| $key=='rss'){
            if ($devOptions['follow_location']=="left"){
            $buildCss .="#follow.".$devOptions['follow_location']." ul li.text_replace a img.".$key." {background:transparent url(".WP_PLUGIN_URL."/share-and-follow/images/impact/word-strip-left.png) no-repeat; background-position:-".$value['leftWhite_Xaxis']."px -".$value['leftWhite_Yaxis']."px;";
            $buildCss .="height:".$value['height']."px;width:".$value['width']."px}\n";
            $buildCss .= "#follow.".$devOptions['follow_location']." ul li.text_replace a img.".$key.":hover {background-position:-".$value['leftBlack_Xaxis']."px -".$value['leftBlack_Yaxis']."px;}\n";
            }
            if ($devOptions['follow_location']=="right"){
            $buildCss .="#follow.".$devOptions['follow_location']." ul li.text_replace a img.".$key." {background:transparent url(".WP_PLUGIN_URL."/share-and-follow/images/impact/word-strip-right.png) no-repeat; background-position:-".$value['rightWhite_Xaxis']."px -".$value['rightWhite_Yaxis']."px;";
            $buildCss .="height:".$value['height']."px;width:".$value['width']."px}\n";
            $buildCss .= "#follow.".$devOptions['follow_location']." ul li.text_replace a img.".$key.":hover {background-position:-".$value['rightBlack_Xaxis']."px -".$value['rightBlack_Yaxis']."px;}\n";
            }
        }
    }
...
$buildCss .="#follow.".$devOptions['follow_location']." ul li.".$devOptions['word_value']." span, #follow ul li a span {display:none}";
    ...
    if ($devOptions['follow_location'] == "bottom"  && $devOptions['follow_list_style'] == "text_replace" ){
        ...
        $buildCss .="#follow.".$devOptions['follow_location']." ul li a {margin-right:".$devOptions['$follow_list_spacing']."; background-image:none !important}\n";
...
if ($devOptions['follow_location'] == "top"  && $devOptions['follow_list_style'] == "text_replace" ){
        ...
        $buildCss .="padding-bottom:10px;list-style-type:none !important; display:inline;}";
        $buildCss .="#follow.".$devOptions['follow_location']." ul li.follow {color:#".$devOptions['follow_color'].";}";
        $buildCss .="#follow.".$devOptions['follow_location']." ul li a {margin-right:".$devOptions['follow_list_spacing']."px; background-image:none !important}";
        $buildCss .="#follow.".$devOptions['follow_location']." ul li.text_replace a {color:white;text-decoration:none;}";
        $buildCss .="#follow.".$devOptions['follow_location']." ul li.text_replace a:hover {color:black;}";
        ...
        $buildCss .="}";
            ...
            $buildCss .="#follow.top ul li {float:left;padding-top:4px;margin-right:".$devOptions['follow_list_spacing']."px;list-style-type:none;}";
...
$buildCss .="li.iconOnly a span.head {display:none}\n";
$buildCss .="ul.socialwrap li {margin:0 ".$devOptions['spacing']."px ".$devOptions['spacing']."px 0 !important;}\n";
...
$buildCss .="ul.followwrap li {margin-right:".$devOptions['spacing']."px;margin-bottom:".$devOptions['spacing']."px;list-style-type:none !important;}\n";
$buildCss .="#follow.right ul.followwrap li, #follow.left ul.followwrap li {margin-right:0px;margin-bottom:0px;}\n";
$buildCss .=".shareinpost {clear:both;padding-top:".$devOptions['top_padding']."px}";
...
$cssAdminOptions['cssid'] = $devOptions['cssid'];
