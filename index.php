...
<? include 'navbar.php'; ?>
    <div id="content">
      <img style="max-width:800px; max-height:600px; float:right" src="./images/phone_homepage.png">
      <h2 style="margin-top:200px">Climbers focused on making climbing more fun and effective.</h2>
    </div>
<? include 'footer.html'; ?>
  </body>
</html>